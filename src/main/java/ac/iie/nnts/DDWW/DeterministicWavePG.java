...
public class DeterministicWavePG {
...
//    }
    ...
    public void inputPG (int key, int value,  long timestamp) throws StorageException {
        //###??overflow?????
...
//    }
    ...
    public long QueryPG() throws StorageException {
...
//    }
    ...
    public static void main(String[] args) throws StorageException, InterruptedException {
        DeterministicWavePG deterministicWavePG = new DeterministicWavePG();
        deterministicWavePG.Initialized(0,5000000,124,"para");
        for (int i=0;i<1000;i++){
            long timestamp =System.currentTimeMillis();
            int key = i;
            int value =i;
            deterministicWavePG.inputPG(key,value,timestamp);
            Thread.sleep(1000);
        }
    }
